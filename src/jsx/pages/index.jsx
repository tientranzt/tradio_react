              ...
              <div className="card">
                <div className="card-header">
                  <div className="media">
                    ...
                    <div className="media-body">Bitcoin</div>
                  </div>
              ...
              <div className="card">
                <div className="card-header">
                  <div className="media">
                    ...
                    <div className="media-body">Dashcoin</div>
                  </div>
                  <p className="mb-0"> 24h</p>
                </div>
                <div className="card-body">
              ...
              <div className="card">
                <div className="card-header">
                  <div className="media">
                    ...
                    <div className="media-body">Tether</div>
                  </div>
                  <p className="mb-0"> 24h</p>
                </div>
                <div className="card-body">
              ...
              <div className="card">
                <div className="card-header">
                  <div className="media">
                    ...
                    <div className="media-body">Eosio</div>
                  </div>
                  <p className="mb-0"> 24h</p>
                </div>
                <div className="card-body">
              ...
              <div className="card">
                <div className="card-header">
                  <div className="media">
                    ...
                    <div className="media-body">Tezos</div>
                  </div>
                  <p className="mb-0"> 24h</p>
                </div>
                <div className="card-body">
                ...
                <div className="col-auto">
                  <div className="trusted-logo">
                    <Link to={"#"}>
                      <img
                        className="img-fluid"
                        src={require("./../../images/brand/1.webp")}
                        alt=""
                      />
                    </Link>
                  </div>
                ...
                <div className="col-auto">
                  <div className="trusted-logo">
                    <Link to={"#"}>
                      <img
                        className="img-fluid"
                        src={require("./../../images/brand/3.webp")}
                        alt=""
                      />
                    </Link>
                  </div>
                ...
                <div className="col-auto">
                  <div className="trusted-logo">
                    <Link to={"#"}>
                      <img
                        className="img-fluid"
                        src={require("./../../images/brand/4.webp")}
                        alt=""
                      />
                    </Link>
                  </div>
                ...
                <div className="col-auto">
                  <div className="trusted-logo">
                    <Link to={"#"}>
                      <img
                        className="img-fluid"
                        src={require("./../../images/brand/5.webp")}
                        alt=""
                      />
                    </Link>
                  </div>
                  ...
                  <div className="card-footer">
                    <div className="meta-info">
                      ...
                      <Link to={"#"} className="post-date">
                        <i className="la la-calendar"></i> 31 July, 2019
                      </Link>
                    </div>
                  </div>
                </div>
